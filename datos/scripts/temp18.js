$(function () {			
    $(document).ready(function() {
				...
				events: {
					load: function() {
						...
						setInterval(function(){
							jQuery.get('./scripts/get_last_data.php', 'arduino=18', function(tsv) {
								var lines = [],
								tsv = tsv.split(":");
								var x =tsv[0]*1000;
		...
		jQuery.get('./scripts/get_data.php', 'arduino=18' , function(tsv, state, xhr) {
            var lines = [],
                date,
                sonda1 = [],
				tsv = tsv.split(";");
			...
			ind = 0;
            options.title.text = "Arduino 18";
            options.chart.renderTo = "arduino18";
